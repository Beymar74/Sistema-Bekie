...
import { LEVEL_MISSIONS as BASIC_LEVEL_MISSIONS, LEVEL_0_STAGES, type LevelKey } from "@/lib/levels";
...
export default function MissionPage() {
  ...
  const unlockedMission = useSyncExternalStore(
    ...
    () => {
      ...
      const key = isIntermediate ? "bekie-level-2-progress" : "bekie-level-0-progress";
      const stages = isIntermediate ? LEVEL_2_STAGES : LEVEL_0_STAGES;
