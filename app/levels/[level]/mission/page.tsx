      ...
      <div className="min-h-[100dvh] bg-white flex flex-col">
        ...
        <main className="flex-1 max-w-screen-xl mx-auto w-full px-5 py-10">
          ...
          >
            ...
            <div className="p-7 rounded-2xl border mb-6 bg-indigo-400/5 border-indigo-400/15">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-indigo-600">{mission.icon}</span>
                ...
                <span className="text-xs font-mono px-2.5 py-1 rounded-full flex-shrink-0 bg-indigo-400/10 text-indigo-600">
                  {mission.badge}
                </span>
              </div>
            </div>
                          ...
                          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                            <div className="flex-1">
                              <div className="flex flex-wrap items-center gap-2 mb-2">
                                <span className="text-xs font-mono px-2 py-1 rounded-full bg-gray-100 text-gray-600 border border-gray-200">
                                  Mision {stage.id}/{LEVEL_3_STAGES.length}
                                </span>
                                <span
                              ...
                              <div className="mt-3 rounded-xl border border-indigo-200 bg-white/80 p-3">
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {stage.learningOutcomes.map((item) => (
                                    <span
                                      key={`${stage.id}-${item}`}
                                      className="text-[10px] font-mono bg-indigo-50 text-indigo-700 px-2.5 py-1 rounded-md border border-indigo-200"
                                    >
                                      {item}
                                    </span>
                                  ))}
                            ...
                            {unlocked ? (
                              <Link
                                ...
                                className="btn-press inline-flex items-center justify-center gap-2 bg-indigo-600 text-white font-bold text-sm px-4 py-2.5 rounded-xl hover:bg-indigo-700 transition-colors"
                              >
            ...
            <Link
              ...
              className="btn-press mt-8 flex items-center justify-center gap-2 w-full bg-indigo-600 text-white font-bold text-sm py-3.5 rounded-xl hover:bg-indigo-700 transition-colors"
            >
              Comenzar tutorial
              <ArrowRight size={16} weight="bold" />
            </Link>
    ...
    <div className="min-h-[100dvh] bg-white flex flex-col">
      ...
      <main className="flex-1 max-w-screen-xl mx-auto w-full px-5 py-10">
        ...
        >
          ...
          <div className="p-7 rounded-2xl border mb-6 bg-cyan-600/5 border-cyan-400/15">
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-cyan-600">{mission.icon}</span>
                  <span className="text-xs font-mono uppercase tracking-wider text-cyan-600">
                    {mission.level} - {mission.levelSlug}
                  </span>
                </div>
                <h1 className="text-3xl font-bold tracking-tight text-gray-900">{mission.title}</h1>
                <p className="mt-2 text-sm text-gray-600 max-w-2xl leading-relaxed">{mission.objective}</p>
              </div>
              <span className="text-xs font-mono px-2.5 py-1 rounded-full flex-shrink-0 bg-cyan-600/10 text-cyan-600">
                {mission.badge}
              </span>
            </div>
          </div>
                  ...
                  {LEVEL_0_STAGES.map((stage) => {
                    ...
                    return (
                      <div
                        key={stage.id}
                        className={`rounded-xl border p-4 ${
                          unlocked ? "border-cyan-300 bg-cyan-50" : "border-gray-200 bg-white"
                        }`}
                      >
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                          <div className="flex-1">
                            ...
                            <div className="mt-3 rounded-xl border border-cyan-200 bg-white/80 p-3">
                              <p className="text-[10px] font-mono uppercase tracking-wider text-cyan-600 mb-2">
                                Lo que aprenderás
                              </p>
                              <div className="flex flex-wrap gap-2">
                                {stage.learningOutcomes.map((item) => (
                                  <span
                                    key={`${stage.id}-${item}`}
                                    className="text-[10px] font-mono bg-cyan-50 text-cyan-700 px-2.5 py-1 rounded-md border border-cyan-200"
                                  >
                                    {item}
                                  </span>
                                ))}
